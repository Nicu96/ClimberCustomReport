...
<a href="https://github.com/ClimberAB/ClimberCustomReport/releases/download/v2.4.4/cl-custom-report-v2.4.4.zip" target="_blank"><img src="./screenshots/downloadbutton.png?raw=true" 
alt="Download latest release" width="400" height="40" border="0" /></a>  

## Most recent update 2.4.4 - 2018-10-28
### Fixed 
